...
export default function MyOrders({ user,orders, order_state, theme, setTheme }){
    ...
    return(
        <div className="flex flex-col items-center w-screen dark:bg-[#252936]">
            ...
            <div className="w-10/12 shadow-xl h-screen bg-gray-50 flex flex-row dark:bg-[#2c3040]">
                ...
                <Orders key={"MyOrders"} orders={orders} selected_state={order_state} setSelectedOrder={setSelectedOrder} toggleOrder={toggleOrder} />
            </div>
